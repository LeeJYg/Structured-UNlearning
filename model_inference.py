...
from sqlToNL import generate_nl_qa_pair
...
def modelInference(model_path, model_id, query_file_path, output_dir):
    ...
    few_shot_example = """\
Q: Who directed the movie "Timegate", a 1993 sci-fi film about dimensional travel?
A: Emily Tran

Q: When was the movie "Shadow Pulse" released?
A: 2007

"""

    for idx, query in tqdm(enumerate(query_list)):
        prompt = f"{few_shot_example}Q: {query}\nA:"
